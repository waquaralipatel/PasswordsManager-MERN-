        ...
        <>
            ...
            <div className="h-[90vh] flex flex-col gap-6 container max-w-5xl mx-auto px-15 py-3 text-white bg-black pt-10 overflow-y-hidden">
                ...
                <div className="save-btn w-full flex justify-between px-2">
                    <p className='text-lg font-bold border-2 border-green-900 rounded-full px-3 text-[#808080]'>Hi..!! I Remember your credentials provide me...</p>
                    <button onClick={savePwd} className='bg-green-700 hover:bg-green-700 rounded-full w-1/7 py-1 font-bold text-black border-2 border-green-900 cursor-pointer'>Save</button>
                </div>
                <div className="passwords-table flex flex-col gap-6 overflow-y-auto">
                    {/*if you want to show the pwd below html code uncode */}
